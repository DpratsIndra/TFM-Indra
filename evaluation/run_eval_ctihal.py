...
def run_evaluation():
    """
    Run an End-to-End evaluation on the CTI-HAL dataset.
    This script processes entire PDFs, extracting techniques and comparing them
    against the ground truth markdown files.
    """
    ...
    print("\n" + "="*80)
    print("[*] INITIATING CTI-HAL EVALUATION")
    ...
    print("\n" + "="*80)
    print(f"[*] MICRO RESULTS FOR {pipeline.upper()}")
    print("="*80)
